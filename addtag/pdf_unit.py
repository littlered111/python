...
class MyPDFHandler(object):
    ...
    def add_one_bookmark(self,title,page,parent = None, color = None,fit = '/Fit'):
        ...
        self.__writeable_pdf.addBookmark(title.encode('utf-8').decode('utf-8'),page - 1,parent = parent,color = color,fit = fit)
        print ("add_one_bookmark success! bookmark title is: {0}")
